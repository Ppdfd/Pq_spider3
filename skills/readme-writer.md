...
Use when user asks to "write a README", "create a readme", "document this project", "generate project documentation", or "help me write a README.md". Works from a project description, existing code, or both
---

# README Writer
## Overview

Generate a complete, professional README.md file, compare is it correctly derive from papers and write it to disk. The output
...
Look for context in the codebase and papers/ before asking the user:
...
- compare what is difference from original papers
...
-what is correct
-what is different, also point out the differences between them and original papers, this is very important.
